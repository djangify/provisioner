...
Each customer gets a subdomain like customer.ebuilder.host
"""
...
class NginxManager:
    ...
    /etc/nginx/sites-enabled/ebuilder-janes-shop.conf
    """
    ...
    def log(self, instance, message):
        ...
        ProvisioningLog.objects.create(
            instance=instance,
            action="create",  # Using 'create' as closest match
    ...
    def generate_config(self, instance):
        ...
        - SSL (assumes wildcard cert exists)
        - WebSocket support
        - Proxy headers
        """
...
"""
    ...
    def write_config(self, instance):
        ...
        # DEBUG: make path explicit
        print("NGINX CONFIG WRITING TO:", config_path)
